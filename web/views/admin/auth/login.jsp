<%-- 
    Document   : login
    Created on : Feb 28, 2022, 5:24:08 PM
    Author     : hieu2
--%>
...
<html>
    ...
    <body>
        <div class="w-full min-h-screen bg-white flex justify-center items-center">
            <div class="w-[400px] px-8 py-10 rounded-[10px]" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                <form class="w-full" method="POST" action="/admin/login">
                    <div class="mb-10 text-center">
                        <h3 class="text-3xl">Admin</h3>
                    </div>
