<%-- 
    Document   : update
    Created on : Mar 17, 2022, 10:51:12 AM
    Author     : hieu2
--%>
                ...
                <div class="flex justify-center min-h-screen items-center">
                    <div class="block p-6 rounded-lg shadow-lg bg-white max-w-md">
                        <form action="/admin/customer/update" method="post">
                            <input type="hidden" name="id" value="${requestScope.customer.id}" id="id"/>
                            <div class="form-group mb-6">
                                <input type="text" id="name" name="name" value="${requestScope.customer.name}"  placeholder="Name"class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" >
                            </div>
                            <div class="form-group mb-6">
                                <input type="text" id="phone" name="phone" value="${requestScope.customer.phone}"  placeholder="Name"class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" >
                            </div>
                            <div class="form-group mb-6">
                                <input type="text" id="email" name="email" value="${requestScope.customer.email}"  placeholder="Name"class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" >
                            </div>
                            <div class="form-group mb-6">
                                <input type="text" id="cmnd" name="cmnd" value="${requestScope.customer.cmnd}"  placeholder="Name"class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" >
                            </div>
