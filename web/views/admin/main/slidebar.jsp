    ...
    <body>
        <div class="w-60 h-full shadow-md bg-white px-1 fixed top-0 left-0" style="width: 235px">
            <ul class="relative">
                ...
                <li class="relative">
                    <a href="/admin/checkout/history"  class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="dark">
                        <span>Checkout</span>
                    </a>
                </li>
                <li class="relative">
                ...
                <li class="relative">
                    <a href="/admin/room"  class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="dark">
                        <span>Room</span>
                    </a>
                </li>
                <li class="relative">
                ...
                <li class="relative">
                    <a href="/admin/customer"  class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="dark">
                        <span>Customer</span>
                    </a>
                </li>
            </ul>
