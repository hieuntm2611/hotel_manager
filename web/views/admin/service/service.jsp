                        ...
                        <c:if test="${search==null && start==null && end==null}">
                            <div class="flex justify-end items-center mr-10 mt-10">
                                <div class="flex space-x-2 justify-center">
                                    <c:if test="${page>1}">
                                        <a href="service?page=${page-1>0?page-1:page}" class="inline-block px-6 py-2 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                                            Prev
                                        </a>
                                    </c:if>
                                    <p class="text-xl mx-10">${page}/${size}</p>
                                    <c:if test="${page<size}">
                                        <a  href="service?page=${page+1<=size?page+1:page}" class="inline-block px-6 py-2 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                                            Next
                                        </a>
                                    </c:if>
                                </div>
