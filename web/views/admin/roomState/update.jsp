            ...
            <div class="w-full px-5">
                <div class="flex justify-center min-h-screen items-center">
                    <div class="block p-6 rounded-lg shadow-lg bg-white max-w-md">
                        <form action="/admin/room/state/update" method="post">
                            <input type="hidden" name="id" value="${requestScope.roomState.id}" id="id"/>
                            <div class="form-group mb-6">
                                <input type="text" id="name" name="name" value="${requestScope.roomState.name}"  placeholder="Name"class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" >
                            </div>
